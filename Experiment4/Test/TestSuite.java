...
public class TestSuite {
    ...
    public void test() {
        ...
        System.out.print(triangle.Triangle.classifyTriangle((int) objects[0], (int) objects[1], (int) objects[2]) + " - " + triangle.Triangle.calculateArea((int) objects[0], (int) objects[1], (int) objects[2]));
        assertEquals(triangle.Triangle.classifyTriangle((int) objects[0], (int) objects[1], (int) objects[2]), (String) objects[3]);
        assertEquals(triangle.Triangle.calculateArea((int) objects[0], (int) objects[1], (int) objects[2]), objects[4]);
    }
